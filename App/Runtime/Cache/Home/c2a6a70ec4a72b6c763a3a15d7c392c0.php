...
<head>
    ...
    <title>关于翼田|翼田石材涂层树脂,辅料,人造石树脂，水晶透明树脂,模压树脂,玻璃钢树脂 ,|翼田简介|</title>
...
<div class="content">
    ...
    <div class="plc2">
		...
		&raquo; <a href="<?php echo U('Index/cutform',array('tid'=>$fcutinfo['ads_id']));?>" title="<?php echo ($fcutinfo["ads_name"]); ?>"><?php echo ($fcutinfo["ads_name"]); ?></a> 
		&raquo; <a href="" title="<?php echo ($cutinfo["ad_name"]); ?>"><?php echo ($cutinfo["ad_name"]); ?></a></div>
    ...
    <div class="left2">
        ...
        <div class="left2_main">
            <div class="n_info_con" id="printableview">
                        ...
                        <div class="n_tit">
                            ...
                            <!--<div class="news_info">
                                <span>文章出处：</span><span>责任编辑：</span><span>作者：</span><span>人气：<span
                                    id="cntrHits">-</span></span>--><span>发表时间：<?php echo ($cutinfo["ad_update"]); ?></span></div>
                        </div>
                    </div>
                </div>
                ...
                <!--<div class="gduo">
                    <span>下一篇：<a  href="http://www.sztyzj.cn#" title="已经是最后一篇了">已经是最后一篇了</a></span>上一篇：<a 
                        href="http://www.sztyzj.cn/Article/gyywzmqxcj_1.html" title="工业油污怎么清洗？常见的工业油污清洗方法有哪些？"> 工业油污怎么清洗？常见的工业油污清洗方法有哪些？</a></div>-->
            </div>
