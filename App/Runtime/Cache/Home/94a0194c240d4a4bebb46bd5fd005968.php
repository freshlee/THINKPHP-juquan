...
<title>教学环境_美迪电商学院</title>
<meta name="keywords" content="" />
<meta name="description" content="" />
<script language="javascript" type="text/javascript" src="/Public/Home/js/conn.js"></script>
<link type="text/css" rel="stylesheet" href="/Public/Home/css/style_4.css" />
<link type="text/css" rel="stylesheet" href="/Public/Home/css/pages_4.css" />
<script type="text/javascript" src="/Public/Home/js/jquery-1.4.3.min.js"></script>
	...
	<link rel="stylesheet" type="text/css" href="/Public/Home/css/jquery.fancybox-1.3.4_1.css" media="screen" />
...
<?php if(is_array($case)): $i = 0; $__LIST__ = $case;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$casevo): $mod = ($i % 2 );++$i;?><DIV class="environment_box">
	<h3><?php echo ($casevo["caseName"]); ?></h3>
    <ul>
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if(($vo["listCase"]) == $casevo["id"]): ?><li><a id="example2" href="/Uploads/environment/<?php echo ($vo["listPic"]); ?>"><img alt="点击查看大图" src="/Uploads/environment/<?php echo ($vo["listPicThumb"]); ?>" width="180" height="135" /><p><?php echo ($vo["listCont"]); ?></p></a></li><?php endif; endforeach; endif; else: echo "" ;endif; ?>
    </ul>
...
<link href="/Public/Home/css/reseller_5.css" rel="stylesheet" type="text/css" media="screen" />
