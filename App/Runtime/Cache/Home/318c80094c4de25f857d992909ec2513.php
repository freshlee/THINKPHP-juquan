...
<?php if(is_array($teacher)): $i = 0; $__LIST__ = $teacher;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="/teacher/624.html" class="teacher_sub">
		<div class="teacher_picture"><img src="/Uploads/teacher/<?php echo ($vo["pic"]); ?>" style="width: 100%;height: 185px;" ></div>
		<h4><strong><?php echo ($vo["teachername"]); ?></strong> <?php echo ($vo["teacherhonor"]); ?></h4>
		<p>
