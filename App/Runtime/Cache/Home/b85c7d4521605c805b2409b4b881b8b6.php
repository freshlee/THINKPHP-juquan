...
function freshVerify() {
 document.getElementById('verifyImg').src='/Home/Index/VerifyImg/'+Math.random();
} 
</script>
<title>世锐－后台登录</title>
...
<form method="post" name="mlogin" action="/Home/Index/ck_adlogin" onSubmit="return cklog(this);" target="_top">
<DIV id=user_login>
<DL>
  <DD id=user_top>
  <UL>
  ...
  <UL>
    ...
    <UL>
      ...
      <LI class=user_main_input><input type="text"  name="verify" id="verify" maxlength="4" size="4"  ><span style="margin-left:40px;"><img style='cursor:pointer' title='刷新验证码' src='/Home/Index/VerifyImg' id='verifyImg' onClick='freshVerify()'/></span> </LI></UL></DIV></LI>
