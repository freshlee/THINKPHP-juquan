...
<title>淘宝/装修/开店/推广干货分享_美迪电商学院</title>
<meta name="keywords" content="" />
<meta name="description" content="" />
<script language="javascript" type="text/javascript" src="/Public/Home/js/conn.js"></script>
<link type="text/css" rel="stylesheet" href="/Public/Home/css/style_3.css" />
<link type="text/css" rel="stylesheet" href="/Public/Home/css/pages_3.css" />
...
<div class="about_box">
	<div class="about_left">
		...
		<div class="article_ad"><a href="http://www.mede.com.cn/course/yunying/"><img src="/Public/Home/picture/ad3_230x250.jpg" alt="淘宝运营推广班" /></a></div>
	</div>
	<div class="about_right">
		<div class="position">您现在的位置是：<a href='http://www.mede.com.cn'>美迪首页</a> > <a href='/share/'>干货分享</a> >  </div>
		<div class="share_body">
		<?php switch($act_show): case "list": ?><ul>
			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                    <div class="news-title">
                        <h2><a href="/share/cate/<?php echo ($vos["InformationTitle"]); ?>" title="PS快速把照片处理成素描的效果"><b><?php echo ($vos["InformationTitle"]); ?></b></a></h2>
                    </div>
                    <div class="news-summary">
                        <p class="info2"><?php echo (substr($vo["InformationCont"],0,20)); ?>...</p><br>
                        <span><a href="/share/act/shownews/num/<?php echo ($vo["id"]); ?>" title="PS快速把照片处理成素描的效果">阅读全文</a></span>
                        <ul>
                            <li class="w1">0人浏览过</li>
                            <li class="w2">发布时间：<?php echo ($vo["InformationUpdate"]); ?></li>
                        </ul>
                    </div>
          ...
          <?php case "news": echo ($news["InformationContent"]); break; endswitch;?>
		</div>
...
<link href="/Public/Home/css/reseller_4.css" rel="stylesheet" type="text/css" media="screen" />
