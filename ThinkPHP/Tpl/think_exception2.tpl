...
<META http-equiv=refresh content="3;URL =<?php echo __ROOT__; ?>">
...
<div class="m404"><a href="<?php echo __ROOT__; ?>"><img src="<?php echo __ROOT__.'/Public/error/404.png'; ?>" width="409" height="177" alt="“真的很抱歉，我们搞丢了页面……”要不去网站首页看看？" border="0"></a></div>
