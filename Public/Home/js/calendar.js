...
function HS_calender(){
	...
	style +=".calender,.calender div{position:relative;margin:0;padding:0; z-index:900; !important; }";
	style +=".calender { width:150px; min-height:160px; font-size:12px;  background: center #fff; border:1px solid #397EAE; padding:1px}";
	...
	if (arguments.length>1){
		...
		var CalenderBox = style+"<iframe style='position:absolute; z-index:-1;width:150px;' frameborder='0' src='about:blank'></iframe><div id='calender' class='calender'><div class='calenderTitle'>"+CalenderTitle+"</div><div class='calenderBody'><ul class='day'><li>日</li><li>一</li><li>二</li><li>三</li><li>四</li><li>五</li><li>六</li></ul><ul class='date' id='thisMonthDate'>"+lis+"</ul></div><div class='calenderBottom'><a href='javascript:void(0)' id='closeCalender' class='closeCalender' onclick='closeCalender(this)'>关闭</a><span><span><a href=javascript:void(0) onclick='_selectThisDay(this)' title='"+todayString+"'>今天</a></span></span><span><a href=javascript:void(0) onclick='_setEmpty(this)' title=''>置空</a></span></div></div>";
		return CalenderBox;
	}
}
...
function setday(inputObj){
	...
	if(calenderObj.style.display == 'block'){
		calenderObj.style.display = 'none';
	}else{
		calenderObj.style.display = 'block';
	}
	//屏蔽鼠标点击事件
	if(isIE){
		calenderObj.attachEvent("onclick",oSpanClick);
	}else{
		calenderObj.addEventListener("click",oSpanClick,false);
